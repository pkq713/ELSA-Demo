...
lsa_compute ../test/ARISA20.csv ../test/ARISA20.mix.lsa -r 1 -s 127 -d 3 -p mix -x 10 -f none -n percentileZ -e ../test/ARISA20.csv -m 0 #3501.449665
lsa_compute ../test/ARISA20.csv ../test/ARISA20.perm.lsa -r 1 -s 127 -d 3 -p perm -x 10 -f none -n percentileZ -e ../test/ARISA20.csv -m 0 #14737.259068
...
lsa_compute ../test/ARISA20.csv ../test/ARISA20.mix.lta -r 1 -s 127 -d 3 -p mix -x 10 -f none -n percentileZ -e ../test/ARISA20.csv -m 0 -a 0.5549 -T 1 #
lsa_compute ../test/ARISA20.csv ../test/ARISA20.perm.lsa -r 1 -s 127 -d 3 -p perm -x 10 -f none -n percentileZ -e ../test/ARISA20.csv -m 0 -a 0.5549 -T 1 #

# 不对，这里是输入两个文件，然后输出结果是中间的那个 ../test/ARISA20.perm.lsa
